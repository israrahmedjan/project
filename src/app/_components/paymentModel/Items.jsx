  ...
  return (
    ...
    <div className="space-y-6 p-6 border rounded-md w-full max-w-md mx-auto mt-10">
      ...
      <div className="flex items-center gap-2 border-red-500 border text-center">
        ...
        <button className="px-3 py-1 bg-red-400 text-white rounded-full ">-</button>
        <span className="text-lg font-semibold items-center">1</span> {/* Quantity */}
        <button className="px-3 py-1 bg-green-400 text-white rounded-full">+</button>
        </div>
      </div>
      ...
      <div>
        <ul className="list-inside  text-gray-700 flex items-center justify-center gap-2">
          <li>Item 1</li>
          <li>Item 2</li>
          <li>Item 3</li>
        </ul>
